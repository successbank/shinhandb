          ...
          <main className="flex-1 overflow-y-auto">
            <div className="px-6 py-12">
              ...
              {uploadState.status === 'success' && (
                <div className="mb-6 bg-gradient-to-r from-green-500 to-emerald-600 text-white p-6 rounded-lg shadow-lg border-l-4 border-green-700 animate-fadeIn">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold mb-1">✅ 업로드 완료!</h3>
                      ...
                      <p className="text-green-100 text-sm mt-2">
                        콘텐츠 목록 페이지에서 확인하실 수 있습니다.
                      </p>
                    </div>
                    <button
                      onClick={() => router.push('/contents')}
                      className="flex-shrink-0 px-6 py-3 bg-white text-green-600 font-semibold rounded-lg hover:bg-green-50 transition-colors shadow-md"
                    >
                      콘텐츠 보기
                    </button>
                  </div>
